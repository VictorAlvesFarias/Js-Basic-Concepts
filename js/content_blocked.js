...
function unlock_ilumipizza() {
    var swith_and_get_time_content = document.getElementById('swith_and_get_time_content_identifier')
    swith_and_get_time_content.style.opacity= "0"

    setTimeout(function() {
        swith_and_get_time_content.style.display="none"
    }, 600);
    setTimeout(function() {
        swith_and_get_time_content.innerHTML ="Conteudo Desbloqueado"
    }, 700);
...
function swith_and_get_time_verify(){
